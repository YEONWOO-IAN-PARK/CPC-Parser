...
/**
 * <p>definition-title-type complex type�� ���� Java Ŭ�����Դϴ�.
 * 
 * <p>���� ��Ű�� ������ �� Ŭ������ ���ԵǴ� �ʿ��� �������� �����մϴ�.
 * 
 * <pre>
 * &lt;complexType name="definition-title-type">
 *   &lt;complexContent>
...
@XmlType(name = "definition-title-type", propOrder = {
    "content"
})
public class DefinitionTitleType {
