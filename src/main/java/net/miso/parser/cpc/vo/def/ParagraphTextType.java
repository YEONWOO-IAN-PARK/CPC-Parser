...
/**
 * <p>paragraph-text-type complex type�� ���� Java Ŭ�����Դϴ�.
 * 
 * <p>���� ��Ű�� ������ �� Ŭ������ ���ԵǴ� �ʿ��� �������� �����մϴ�.
 * 
 * <pre>
 * &lt;complexType name="paragraph-text-type">
 *   &lt;complexContent>
 ...
 *         &lt;element ref="{}sup"/>
 *       &lt;/choice>
 *       &lt;attribute name="type" type="{}paragraph-text-category-type" default="body" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "paragraph-text-type", propOrder = {
    "content"
})
public class ParagraphTextType {
    ...
    protected ParagraphTextCategoryType type;
     ...
     * @return
     *     possible object is
     *     {@link ParagraphTextCategoryType }
     *     
     */
    public ParagraphTextCategoryType getType() {
        if (type == null) {
            return ParagraphTextCategoryType.BODY;
        } else {
            return type;
        }
    }
     ...
     *     
     */
    public void setType(ParagraphTextCategoryType value) {
        this.type = value;
    }
