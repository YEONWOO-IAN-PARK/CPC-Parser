...
/**
 * Markup potentially contained within elements in warning and notes etc.
 * 
 * <p>note-paragraph-type complex type에 대한 Java 클래스입니다.
 * 
 * <p>다음 스키마 단편이 이 클래스에 포함되는 필요한 콘텐츠를 지정합니다.
 * 
 * <pre>
 * &lt;complexType name="note-paragraph-type">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;choice maxOccurs="unbounded" minOccurs="0">
 *         &lt;element ref="{}reclassification-date"/>
...
@XmlType(name = "note-paragraph-type", propOrder = {
    "content"
})
@ToString
public class NoteParagraphType {

    @XmlElementRefs({
        @XmlElementRef(name = "reclassification-date", type = JAXBElement.class, required = false),
    ...
    @XmlAttribute(name = "warning-type")
    protected WarningCategoryType warningType;

    /**
     * Markup potentially contained within elements in warning and notes etc.Gets the value of the content property.
     * 
     * <p>
    ...
    /**
     * warningType 속성의 값을 가져옵니다.
     * 
     * @return
     *     possible object is
     *     {@link WarningCategoryType }
     *     
     */
    public WarningCategoryType getWarningType() {
        return warningType;
    }

    /**
     * warningType 속성의 값을 설정합니다.
     * 
     * @param value
     *     allowed object is
     *     {@link WarningCategoryType }
     *     
     */
    public void setWarningType(WarningCategoryType value) {
