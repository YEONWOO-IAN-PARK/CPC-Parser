...
/**
 * <p>note-type complex type에 대한 Java 클래스입니다.
 * 
 ...
 *       &lt;/sequence>
 *       &lt;attribute name="type" use="required" type="{}note-and-warning-category-type" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class NoteType {
    ...
    protected NoteAndWarningCategoryType type;
    ...
    public List<NoteParagraphType> getNoteParagraph() {
        if (noteParagraph == null) {
            noteParagraph = new ArrayList<NoteParagraphType>();
        }
     ...
     * @return
     *     possible object is
     *     {@link NoteAndWarningCategoryType }
     *     
     */
    public NoteAndWarningCategoryType getType() {
        return type;
    }
     ...
     *     
     */
    public void setType(NoteAndWarningCategoryType value) {
        this.type = value;
    }
